...
def solve_attributed_hybrid_DNCDP_1hop(G, partitions, export_path, hybrid_rate):
        ...
        for _part in range(num_partition):
            ...
            for c_count, component in enumerate(nx.connected_components(H)):
                ...
                if len(list(component)) > 30:
                    ...
                    new_row = {dividing_col: identifier, 'partition': _part, 'c_count': c_count, 'component_size': N, 'component_edges': M,
                            'budget': K,
...
def solve_attributed_DCNDP_1hop(G, G_attributes_df, export_path):
    ...
    for hybrid_rate in hybrid_rates:
        ...
        solve_attributed_hybrid_DNCDP_1hop(G, partitions, export_path, hybrid_rate)
...
def main(DATA_PATH, meta_root_export_dir):
    ...
    for g_name in os.listdir(DATA_PATH):
        ...
        hybrid_results_l = solve_attributed_DCNDP_1hop(orig_G, G_attributes_df, g_export_path)
...
if __name__ == "__main__":
    ...
    # python DCNDP_1hop_Partition_Regional.py --export_path DCNDP_1hop_NL_D2_2023_06_28_healthAuthority_ID --input_path DCNDP_Datasets/NL_Day2 --dividing_col healthAuthority_ID --partition_avg_size 25000 --partition_remove_budget 0.2 --timelimit 3600 >> DCNDP_1hop_NL_D2_2023_06_28_healthAuthority_ID.txt 
